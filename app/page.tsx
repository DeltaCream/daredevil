            ...
            <div className="flex flex-col gap-16 px-8 py-24 text-center">
                <div className="flex flex-col items-center justify-center gap-8">
                    <Link href="https://github.com/DeltaCream/daredevil">
                        <Announcement>
                            ...
                            <AnnouncementTitle>
                                The website is undergoing many changes!
                            </AnnouncementTitle>
                        </Announcement>
                    </Link>
                    ...
                    <p className="mt-0 mb-0 text-balance text-lg text-muted-foreground">
                        This is a project website which aims to create a space
                        to share ideas with the world. It showcases various
                        ideas and topics worth checking out.
                    </p>
                ...
                >
                    ...
                    <VideoPlayerControlBar key={"video-player-control-bar"}>
                        <VideoPlayerPlayButton
                            key={"video-player-play-button"}
                        />
                        <VideoPlayerSeekBackwardButton
                            key={"video-player-seek-backward-button"}
                        />
                        <VideoPlayerSeekForwardButton
                            key={"video-player-seek-forward-button"}
                        />
                        <VideoPlayerTimeRange key={"video-player-time-range"} />
                        <VideoPlayerTimeDisplay
                            showDuration
                            key={"video-player-duration"}
                        />
                        <VideoPlayerMuteButton
                            key={"video-player-mute-button"}
                        />
                        <VideoPlayerVolumeRange
                            key={"video-player-volume-range"}
                        />
                    </VideoPlayerControlBar>
                </VideoPlayer>
            </div>
