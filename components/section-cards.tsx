...
//consult https://www.shadcn.io/ui/card for documentation
export function SectionCards({ content }: SectionCardProps) {
    // let presentEmployees = content[0];
    // let presentSupervisors = content[1];
    return (
