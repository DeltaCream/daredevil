...
import { IconVolume } as Tabler from "@tabler/icons-react"; 
...
const initialState: State = { singleMode: false, playingIds: new Set() };
...
function reducer(state: State, action: Action): State {
    switch (action.type) {
        case "SET_SINGLE_MODE":
            return { ...state, singleMode: action.value };
        case "PLAY": {
            if (state.singleMode) {
